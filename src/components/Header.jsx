        ...
        {mobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 h-full w-80 bg-white shadow-2xl z-50 lg:hidden border-l-2 border-accent"
            >
              {/* Close Button */}
              <button
                onClick={() => setMobileMenuOpen(false)}
                className="absolute top-4 right-4 text-gray-800 p-2 hover:bg-gray-100 rounded-lg transition"
              ...
              {/* Logo in Menu */}
              <div className="p-6 border-b-2 border-accent bg-bg">
                <Image 
                  src="/Logo-nobg.png" 
                  alt="FEAL Logo" 
                  width={120} 
              ...
              <div className="absolute bottom-6 left-6 right-6 text-gray-800 text-sm border-t-2 border-accent pt-6 bg-bg p-4 rounded-lg">
